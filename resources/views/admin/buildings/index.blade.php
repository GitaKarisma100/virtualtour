                        ...
                        <tr class="hover:bg-surface-container-low transition-colors group">
                            ...
                            <td class="px-lg py-md text-right">
                                <div class="flex items-center justify-end gap-sm">
                                    <a href="{{ route('admin.buildings.locations.index', $building) }}" class="p-sm rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors" title="Manage Locations">
                                        <span class="material-symbols-outlined" data-icon="photo_library">photo_library</span>
                                    </a>
                                    <a href="{{ route('admin.buildings.edit', $building) }}" class="p-sm rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors" title="Edit">
                                        <span class="material-symbols-outlined" data-icon="edit">edit</span>
                                    </a>
                                    <form action="{{ route('admin.buildings.destroy', $building) }}" method="POST" class="inline" data-confirm="Yakin ingin menghapus building ini? Semua lokasi dan hotspot di dalamnya juga akan terhapus.">
                                        @csrf
                                        @method('DELETE')
